...
cover_letter_app = gr.Interface(
    ...
    inputs=[
        ...
        # If just keywords are desired can replace next line with gr.Textbox(label="Job Skills Keywords",
        # placeholder="Paste the job required skills keywords here...", lines=2),
